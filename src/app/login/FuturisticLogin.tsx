    ...
    <ProtectedRoute requireAuth={false}>
      <div className="relative flex justify-center items-center min-h-screen px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-neon-purple/20 rounded-full blur-3xl animate-float-3d" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-neon-pink/20 rounded-full blur-3xl animate-float-3d" style={{ animationDelay: '4s' }}></div>
        </div>
