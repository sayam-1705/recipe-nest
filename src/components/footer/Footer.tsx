...
const Footer = () => {
  return (
    <div>
      <div className="grid grid-cols-4 gap-10 bg-color-dark-green text-color-white animate-fade-in-up px-20 py-12">
        <div className="flex flex-col gap-5">
          <div className="flex items-center gap-2 transition-transform duration-300">
            ...
            <span className="font-bold text-2xl">RecipeNest</span>
          </div>
          <div className="flex flex-col gap-2 text-base font-medium opacity-80 transition-opacity duration-300 group-hover:opacity-100">
        ...
        <div className="flex flex-col gap-5 transform transition-transform duration-300">
          <h3 className="text-lg font-bold border-b-2 border-transparent transition-colors duration-300 pb-1">
            Quick Links
          </h3>
          <div className="flex flex-col gap-2 text-base font-medium">
            <Link
              className="hover:underline transition-all duration-300 hover:text-orange-300 hover:translate-x-2"
              href="/"
            >
              How it works
            </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="white"
                className="transition-colors duration-300 hover:fill-orange-400"
              >
      ...
      <div className="bg-[#00312d] text-center text-white italic text-sm py-2">
        Copyright @ 2025
      </div>
    </div>
  );
