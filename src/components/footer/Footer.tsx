...
const Footer = () => {
  return (
    <div id="contact">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="text-neutral-cream transition-colors duration-300 hover:text-primary-orange"
              >
      ...
      <div className="bg-secondary-green-darker text-center text-neutral-cream italic text-sm py-2">
        Copyright @ 2025
      </div>
    </div>
  );
