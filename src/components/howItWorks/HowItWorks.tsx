const HowItWorks = () => {
  return (
    <div className="bg-green-800 flex flex-col items-center text-neutral-100 py-16 pb-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-neutral-100 rounded-full animate-subtle-pulse delay-500"></div>
      </div>
        ...
        <div className="flex justify-around gap-14 items-center pt-12 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center w-[300px] group hover:transform hover:-translate-y-2 transition-all duration-500 ease-out animate-fade-in-up delay-200">
            <div className="relative">
              <svg
                className="w-20 h-20 border-2 border-neutral-100 rounded-full p-5 transition-all duration-300 group-hover:border-opacity-80 group-hover:scale-110 group-hover:shadow-2xl group-hover:shadow-neutral-100/20"
