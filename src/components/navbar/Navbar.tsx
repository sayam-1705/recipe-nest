  ...
  return (
    <nav className="flex justify-between items-center px-14 py-3 bg-white shadow-sm transition-all duration-500 hover:shadow-md animate-fade-in-up">
      ...
      >
        ...
        <span className="font-bold text-2xl text-color-dark-green ml-2 transition-all duration-500 group-hover:text-color-orange animate-shimmer">
          RecipeNest
        </span>
      </Link>
      ...
      <div className="flex gap-4 font-medium text-base animate-fade-in-up delay-1000">
        ...
        <Link
          className="border-[1px] border-color-orange px-4 py-1.5 rounded-3xl bg-color-orange transition-all duration-500 hover:bg-orange-600 hover:border-orange-600 hover:scale-110 hover:shadow-lg active:scale-95 text-white transform"
          href="/signup"
        >
          Sign Up
        </Link>
