  ...
  return (
    ...
    >
      ...
      <input
        ...
        min={min}
        max={max}
        className={`w-full px-3 sm:px-4 py-3 sm:py-4 text-sm sm:text-base rounded-xl border-2 border-neutral-200 focus:outline-none focus:ring-0 focus:border-primary-orange focus:shadow-none outline-none transition-all duration-300 ease-out hover:border-primary-orange-light hover:shadow-md bg-neutral-white shadow-sm transform active:border-primary-orange active:outline-none ${
          disabled
